...
emoji_file = os.path.join(os.path.dirname(__file__), "..", "3rdparty", "include", "IconsEmoji.h")
dst_file = os.path.join(os.path.dirname(__file__), "..", "pcsx2", "ImGui", "ImGuiGlyphRanges.inl")
