...
void MainWindow::setupStatusBarWidgets()
{
	...
	m_status_volume_widget->setToolButtonStyle(Qt::ToolButtonTextOnly);
	...
	m_status_speed_widget->setToolButtonStyle(Qt::ToolButtonTextOnly);
...
void MainWindow::setStatusVolumeText(const QString& text, int volume)
{
